...
-  **AI解析**：集成 LLM，自动校对变形结果并生成实用例句。
-  **开箱即用**：开源免费，提供轻量级RESTful API，方便其他开发者接入自己的应用。
...
非常欢迎提交 Issue 和 PR！（问题很多..
如果你发现了任何动词变形的 Edge Case，或者想添加新的特性（如敬语/谦让语生成），请随时参与进来！

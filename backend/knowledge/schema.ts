...
export function loadVecExtension(db: any): boolean {
...
export function ensureKnowledgeSchema(db: any): void {
  db.exec(`
...
export function ensureVecTable(db: any, dim: number): boolean {
...
export function dropVecTable(db: any): void {

...
export const subagentSandboxPolicies: Record<string, SandboxPolicy> = {
  researcher: {
    id: 'researcher',
...
export function getSubagentSandboxPolicy(subagentId: string = ''): SandboxPolicy {

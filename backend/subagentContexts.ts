export function buildPlannerContext(intent: any = {}): any {
  return {
...
export function buildExampleDesignerContext(message: string = '', intent: any = {}): any {
...
export function buildPracticeCoachContext(message: string = '', context: any = {}): any {
  return {
    mode: 'practice',
    originalRequest: message,
...
export function buildMemoryManagerContext(context: any = {}): any {
  return {
...
export function formatPlannerNote(plannerNote: any = {}): string {
  return [
...
export function formatSpecialistNote(specialistId: string, brief: any = {}): string {
...
export function serializeSpecialistBrief(label: string, brief: any = {}): string {
